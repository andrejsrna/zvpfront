...
export default async function ArticlesPage({ searchParams }: ArticlesPageProps) {
  ...
  const totalPosts = selectedCategory ? selectedCategory.count : 
  ...
  return (
    <div className="bg-white">
      ...
      <div className="border-b">
        <div className="container mx-auto px-4">
          <div className="flex overflow-x-auto py-4 -mx-4 px-4 gap-2 
            scrollbar-hide">
            <Link
              href="/clanky"
          ...
          {totalPages > 1 && (
            <div className="mt-12 flex justify-center gap-2">
              {page > 1 && (
                <Link
                  href={`/clanky?${
                    selectedCategory ? `kategoria=${selectedCategory.slug}&` : ''
                  }page=${page - 1}`}
