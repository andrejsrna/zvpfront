...
export default async function Hero() {
  ...
  const imageUrl = featuredPost._embedded?.['wp:featuredmedia']?.[0]?.source_url;
  const imageAlt = featuredPost._embedded?.['wp:featuredmedia']?.[0]?.alt_text || featuredPost.title.rendered;
        ...
        <div className="grid lg:grid-cols-2 gap-8 h-full items-center">
          ...
          <div className="space-y-8 max-w-xl">
            <div className="flex items-center space-x-4">
              <span className="flex items-center px-4 py-2 bg-teal-500/10 text-teal-700 
          ...
          <div className="hidden lg:block relative h-[600px] w-full">
            <div className="absolute inset-0 bg-gradient-to-br from-teal-100/50 to-blue-100/50 
              ...
              {imageUrl ? (
                ...
                <div className="w-full h-full bg-gradient-to-br from-teal-200 to-blue-200 
                  animate-pulse" />
              )}
              <div className="absolute inset-0 bg-gradient-to-t from-teal-900/20 
