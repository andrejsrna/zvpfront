...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    quote: "Zdravie v praxi mi ukázalo, že zdravý životný štýl nemusí byť komplikovaný. Malé zmeny priniesli veľké výsledky."
  },
  {
    id: 2,
    name: "Peter M.",
    ...
    quote: "Pravidelné cvičenie podľa odporúčaní odborníkov mi zmenilo život. Konečne môžem žiť aktívne bez bolesti."
  },
  {
    id: 3,
    name: "Jana H.",
    ...
    quote: "Techniky mindfulness a relaxácie, ktoré som sa naučila z článkov, mi pomohli nájsť rovnováhu v živote."
  }
];
            ...
            <div className="grid md:grid-cols-2 gap-0">
              <div className="relative h-64 md:h-full min-h-[400px]">
                ...
                <div className="absolute bottom-6 left-6 right-6 text-white">
                  <div className="bg-emerald-600/90 backdrop-blur-sm rounded-lg px-4 py-2 
                    inline-block mb-3">
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center">
                <svg className="w-12 h-12 text-emerald-500 mb-6 opacity-20" 
            ...
            {TESTIMONIALS.map((testimonial, index) => (
              <button
                ...
                className={`relative rounded-xl overflow-hidden h-24 transition-all 
                  ${activeIndex === index ? 'ring-2 ring-emerald-500 ring-offset-2' : 
