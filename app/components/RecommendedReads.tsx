...
export default function RecommendedReads({ currentPostId, currentCategoryId }: RecommendedReadsProps) {
  const [recommendedPost, setRecommendedPost] = useState<WordPressPost | null>(null);
            ...
            <div className="relative aspect-[4/3] md:aspect-auto">
              {recommendedPost._embedded?.['wp:featuredmedia'] ? (
                ...
                <div className="w-full h-full bg-gradient-to-br from-emerald-100 
                  ...
                  <svg className="w-20 h-20 text-emerald-500 opacity-50" 
            ...
            <div className="p-8 flex flex-col justify-between">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4 
                  ...
                  dangerouslySetInnerHTML={{ __html: recommendedPost.title.rendered }}
                />
                
                <div className="text-gray-600 mb-6 line-clamp-3"
                  dangerouslySetInnerHTML={{ __html: recommendedPost.excerpt.rendered }}
                />
              </div>
              ...
              <div className="flex items-center justify-between mt-auto">
                <div className="flex items-center space-x-4">
                  <div className="flex items-center text-emerald-600 font-medium">
                    Čítať článok
                    <svg className="w-5 h-5 ml-1 transform group-hover:translate-x-1 
