        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="lead text-xl text-gray-600 mb-8">
              Na našej stránke používame cookies a podobné technológie na
              zlepšenie vášho zážitku z prehliadania a poskytovanie
            ...
            <section className="mb-12">
              ...
              <p>
                ...
                prehliadači pri návšteve webových stránok. Pomáhajú nám:
              </p>
              <ul>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p>
                    Pomáhajú nám pochopiť, ako návštevníci používajú našu
                    stránku. Všetky informácie sú anonymné.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Umožňujú stránke zapamätať si vaše voľby (napríklad jazyk) a
                    poskytovať vylepšené funkcie.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Používajú sa na sledovanie návštevníkov naprieč webovými
                    stránkami. Zámerom je zobrazovať reklamy, ktoré sú
            ...
            <section className="mb-12">
              ...
              <p>
                ...
                Môžete ich však kedykoľvek vymazať alebo nastaviť svoj
                prehliadač tak, aby ich blokoval.
              </p>
              <p className="mt-4">
            ...
            <section className="mb-12">
              <h2>Upozornenie</h2>
              <p>
                Blokovanie niektorých typov cookies môže ovplyvniť vašu
                skúsenosť na našich stránkach a služby, ktoré sme schopní
                ponúknuť.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Vyhradzujeme si právo kedykoľvek upraviť tieto zásady používania
                cookies. Akékoľvek zmeny budú účinné ihneď po zverejnení na
                tejto stránke.
              </p>
